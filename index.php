		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>CHECKER TERRA EMAIL</strong></h4>
...
<h5>Creditos:<span class="badge badge-dark float-right saldo"></span></h5>
                  </div> 
                </div>
              </div>
